...
public class RobotMap {
	...
	public static final double driveToScaleY = 310;//(guess)y-axis distance to drive to scale
	...
	public static final boolean sendHelp = false;//change to true when we play Strike Force
}
